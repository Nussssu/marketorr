...
class MediaSeeder extends Seeder
{
    ...
    private function sabditaSet(): array
    {
        return [
            ...
            ['/images/work/sabdita/logo-motion-s.gif', 'sabdita-logo-motion-s.gif', 'Sabdita Fashion S logo animation'],
            ['/images/work/sabdita/logo-animation.gif', 'sabdita-logo-animation.gif', 'Sabdita Fashion animated logo'],
