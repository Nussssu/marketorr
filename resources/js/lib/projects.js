...
export const PROJECTS = [
    {
        ...
        imageAlt: 'Imperial Jute B2B SEO case study cover',
    ...
    },
    {
        ...
        year: '2023',
        description:
            'Comprehensive keyword research, content mapping, on-page and technical SEO built topical authority for a US commercial cleaning provider — 12,000 organic users and $6,447 average monthly sales across the year.',
        metric: '$431,967',
        metricLabel: 'Gross Sales',
        accent: '#507AF4',
        image: '/images/work/commercial-cleaning-seo.jpg',
        imageAlt: 'Commercial cleaning SEO case study cover',
