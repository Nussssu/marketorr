...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="noise relative overflow-hidden bg-[#0B0B0E] py-24 md:py-36"
      onMouseMove={(e) => {
    ...
    >
      ...
      >
        ...
        <div className="absolute right-[22%] bottom-[8%] h-24 w-24 rounded-full blur-[70px]" style={{ background: "rgba(27,226,235,0.12)" }} />
      </div>
      ...
      <div className="container-x relative">
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 lg:pt-4">
            <motion.p
              ...
              className="text-[16px] leading-relaxed text-[#9A9AA3]"
            >
            ...
            <a href="#services" data-cursor="explore" className="link-underline btn-press mt-6 inline-block text-[13px] font-bold uppercase tracking-[0.18em] text-white">
        ...
        <div className="mt-16 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 lg:grid-cols-4">
          {METRICS.map((m, i) => (
            <div key={m.label} className="bg-[#111116] p-7 md:p-9">
              <p className="font-display text-4xl font-extrabold text-white md:text-5xl">
                <Counter to={m.value} suffix={m.suffix} />
              </p>
              <p className="mt-2 text-[12px] font-bold uppercase tracking-[0.18em] text-white/50">{m.label}</p>
              <span
